...
**Question Types:**
1. **Multiple Choice:** Radio buttons, vertical stack, gap-3
...
4. **Cognitive Profile:** Slider component with labels at extremes
...
- Metric overview cards (My Progress, Tasks Completed, Current Average)
...
- Class overview charts with Recharts
...
**No Hero Images** - Utility-focused application prioritizes data over decoration
...
- Buttons: Built-in variant states
